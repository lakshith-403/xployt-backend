...
public class ProjectServiceTest {
  ...
  public void setUp() {
    ...
    try {
      TEST_CLIENT_ID = SetupUsers.makeTestClientRandom("Test Client", "test@test.com", conn);
    } catch (Exception e) {
      e.printStackTrace();
    ...
    String json = "{\"clientId\":\"" + TEST_CLIENT_ID
        + "\",\"title\":\"Test Project\",\"description\":\"This is a test project.\",\"startDate\":\"2024-01-01\",\"endDate\":\"2024-12-31\",\"url\":\"http://example.com\",\"technicalStack\":\"Java, Spring\"}";
